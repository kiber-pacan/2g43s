...
void PipelineCreation::createPostprocessPipeline(VkDevice& device, VkPhysicalDevice& physicalDevice, VkPipelineLayout& pipelineLayout, VkPipeline& graphicsPipeline, VkDescriptorSetLayout& descriptorSetLayout, VkFormat& swapchainImageFormat) {
        auto vertShaderCode = Tools::readFile("/home/down1/2g43s/core/shaders/postProcessingVert.spv");
        auto fragShaderCode = Tools::readFile("/home/down1/2g43s/core/shaders/postProcessingFrag.spv");
